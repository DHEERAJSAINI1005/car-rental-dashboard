...
let listings = [
  ...
  { id: 2, title: 'Honda Civic', status: 'approved', price: 55, location: 'San Francisco' },
  { id: 3, title: 'Fortuner', status: 'rejected', price: 70, location: 'Chicago' },
  { id: 4, title: 'Hyundai Elantra', status: 'approved', price: 48, location: 'Los Angeles' },
  { id: 5, title: 'Maruti Swift', status: 'pending', price: 40, location: 'Dallas' },
  { id: 6, title: 'BMW X5', status: 'approved', price: 95, location: 'Miami' },
  ...
  { id: 9, title: 'Kia Seltos', status: 'approved', price: 50, location: 'Denver' },
  { id: 10, title: 'Skoda Octavia', status: 'pending', price: 52, location: 'Boston' },
  { id: 11, title: 'Jeep Compass', status: 'approved', price: 65, location: 'Phoenix' },
  ...
  { id: 14, title: 'Chevrolet Spark', status: 'approved', price: 38, location: 'Las Vegas' },
  { id: 15, title: 'MG Hector', status: 'rejected', price: 60, location: 'San Diego' },
  { id: 16, title: 'Volkswagen Polo', status: 'approved', price: 42, location: 'Portland' },
